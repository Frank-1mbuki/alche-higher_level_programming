#!/usr/bin/python3
"""
This module defines a Rectangle class with customizable print symbol capabilities,
instance tracking, and property validation.
"""


class Rectangle:
    """
    Defines a rectangle with encapsulated attributes, instance counter,
    customizable print symbol, and string representations.
    """
